...
def MED_preprocessing(
    ...
    for cls in os.listdir(extracted_data_path):
        img_lists = os.listdir(os.path.join(extracted_data_path,cls))
        ...
        copy_data(train_img_list, train_path, extracted_data_path, cls, data_size)
        copy_data(val_img_list, val_path, extracted_data_path, cls, data_size)
        copy_data(test_img_list, test_path, extracted_data_path, cls, data_size)
        shutil.rmtree(os.path.join(extracted_data_path,cls))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--val_size', type=float, default=0.2,
                        ...
                        required=False)
    parser.add_argument('--data_size', type=float, default=20,
